...
--
-- Host: localhost:3306
-- Generation Time: Mar 13, 2021 at 02:49 PM
...
CREATE TABLE `sponsorgamer@gmail.com_factors` (
  ...
  `sumT` int(11) DEFAULT NULL,
  `sumT10` int(11) DEFAULT NULL,
  `sumT15` int(11) DEFAULT NULL,
  `sumT20` int(11) DEFAULT NULL,
...
INSERT INTO `sponsorgamer@gmail.com_factors` (`id`, `year`, `culture`, `square`, `sumO`, `sumT`, `sumT10`, `sumT15`, `sumT20`, `sumO2`, `sumB`, `sumB40`, `sumB45`, `sumB50`, `chdO`, `chdT10`, `chdT15`, `chdT20`, `chdO2`, `chdB40`, `chdB45`, `chdB50`) VALUES
(1, 1970, 'Поле1', 'Культура1, Культура2', 9.8, 429, 360, 273, 63, 9.8, 869, 350, 310, 219, 2, 22, 15, 4, 2, 7, 6, 4),
(2, 1972, 'Поле2', 'Культура1', 22.3, 470, 451, 312, 63, 21.1, 938, 299, 255, 111, 3, 28, 17, 3, 2, 6, 5, 2),
(3, 1974, 'Поле1', 'Культура3', 59.3, 379, 303, 123, 0, 55, 1542, 1380, 1044, 761, 13, 21, 7, 0, 9, 26, 18, 12),
(4, 1975, 'Поле3', 'Культура1, Культура3', 36.5, 375, 567, 529, 253, 36.5, 852, 228, 102, 54, 2, 30, 27, 12, 2, 5, 2, 1),
(5, 1976, 'Поле2', 'Культура1, Культура2', 66.9, 367, 299, 151, 0, 63.6, 1503, 1118, 1078, 987, 10, 21, 9, 0, 8, 19, 18, 16),
(6, 1977, 'Поле2', 'Культура2, Культура3', 10.6, 502, 466, 396, 206, 9.7, 1151, 673, 460, 415, 3, 27, 21, 10, 2, 13, 8, 7),
(7, 1978, 'Поле1', 'Культура1', 30.9, 374, 322, 100, 0, 28.7, 1437, 1046, 963, 868, 8, 24, 6, 0, 6, 17, 15, 13),
(8, 1979, 'Поле1', 'Культура1', 19.9, 575, 575, 484, 289, 19.9, 841, 194, 153, 107, 3, 31, 24, 13, 3, 4, 3, 1),
(9, 1980, 'Поле3', 'Культура2', 105.8, 348, 260, 99, 0, 102.5, 1568, 1191, 1147, 960, 13, 18, 6, 0, 10, 19, 18, 14),
(10, 1982, 'Поле2', 'Культура3', 65.2, 398, 357, 129, 0, 65.2, 1255, 675, 342, 394, 10, 26, 7, 0, 10, 14, 6, 5),
(11, 1986, 'Поле1', 'Культура2, Культура3', 30.1, 438, 388, 327, 87, 29.5, 1119, 410, 410, 219, 6, 23, 18, 4, 3, 7, 7, 2),
(12, 1987, 'Поле2', 'Культура3, Культура2', 33.2, 469, 442, 256, 84, 30.2, 1254, 781, 492, 355, 8, 28, 14, 4, 4, 16, 9, 9),
(13, 1988, 'Поле1', 'Культура1', 22.5, 471, 437, 323, 103, 20.3, 949, 307, 223, 177, 8, 27, 18, 5, 5, 6, 4, 3),
(14, 1989, 'Поле2', 'Культура2', 50.2, 433, 410, 212, 0, 49.4, 1325, 783, 624, 369, 10, 28, 13, 0, 8, 15, 9, 8),
(15, 1990, 'Поле3', 'Культура3', 38.1, 373, 311, 112, 0, 36.2, 1158, 629, 382, 291, 10, 23, 7, 0, 5, 13, 7, 5);
